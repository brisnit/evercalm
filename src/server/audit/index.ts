...
export const AUDIT_ACTIONS = {
  ...
  EMPLOYMENT_CONTACT_CHANGED: 'employment.contact_changed',
  ...
  TRAINING_COURSE_PUBLISHED: 'training_course.published',
  TRAINING_DRAFT_STARTED: 'training_course.new_draft',
  TRAINING_DRAFT_DISCARDED: 'training_course.draft_discarded',
  TRAINING_COURSE_ARCHIVED: 'training_course.archived',
  TRAINING_COURSE_RESTORED: 'training_course.restored',
  TRAINING_ASSIGNED: 'training.assigned',
  TRAINING_ASSIGNMENT_WITHDRAWN: 'training.assignment_withdrawn',
  TRAINING_ASSIGNMENT_VERSION_MOVED: 'training.assignment_version_moved',
  TRAINING_ATTEMPT_ALLOWED: 'training.attempt_allowed',
  TRAINING_QUIZ_ATTEMPTED: 'training.quiz_attempted',
  TRAINING_COMPLETED: 'training.completed',
  TRAINING_SIGNOFF_REQUESTED: 'training_signoff.requested',
  TRAINING_SIGNOFF_VERIFIED: 'training_signoff.verified',
  TRAINING_SIGNOFF_RETURNED: 'training_signoff.returned',
  // shift operations
  OPS_TEMPLATE_CREATED: 'ops_template.created',
  OPS_TEMPLATE_PUBLISHED: 'ops_template.published',
  OPS_TEMPLATE_DRAFTED: 'ops_template.new_draft',
  OPS_TEMPLATE_DRAFT_DISCARDED: 'ops_template.draft_discarded',
  OPS_TEMPLATE_ARCHIVED: 'ops_template.archived',
  OPS_TEMPLATE_RESTORED: 'ops_template.restored',
  OPS_RUNS_GENERATED: 'ops_run.generated',
  OPS_RUN_CANCELLED: 'ops_run.cancelled',
  OPS_RUN_REASSIGNED: 'ops_run.reassigned',
  OPS_TASK_COMPLETED: 'ops_task.completed',
  OPS_TASK_SUBMITTED: 'ops_task.submitted',
  OPS_TASK_SKIPPED: 'ops_task.skipped',
  OPS_TASK_BLOCKED: 'ops_task.blocked',
  OPS_TASK_UNBLOCKED: 'ops_task.unblocked',
  OPS_TASK_VERIFIED: 'ops_task.verified',
  OPS_TASK_RETURNED: 'ops_task.returned',
  OPS_TASK_REASSIGNED: 'ops_task.reassigned',
  OPS_TASK_REOPENED: 'ops_task.reopened',
